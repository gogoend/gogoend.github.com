            ...
            if (rawMatrix.length == 9) {
                ...
                */
                ...
                if (target instanceof Element) {
                    ...
                    var m={};
                    m.elements = result.transformMatrix;
                    console.log(m);
    ...
    function mouseHandler(e) {
        ...
        switch (e.type) {
            ...
            case 'mousemove': {
                ...
                else if (target instanceof THREE.Object3D)   target.setRotationFromMatrix(result.transformMatrixList);                //target.applyMatrix(result.transformMatrixList);
                return result;
                break;
            };
            case 'mouseup': {
