...
class Stick {
    constructor(conf) {
        ...
        //设置zone在视口中的位置
        if (conf.position[0] !== null)
            zone.style.top = conf.position[0] + 'px';
        if (conf.position[1] !== null)
            zone.style.right = conf.position[1] + 'px';
        if (conf.position[2] !== null)
            zone.style.bottom = conf.position[2] + 'px';
        if (conf.position[3] !== null)
            zone.style.left = conf.position[3] + 'px';
        ...
        this.originX = parseInt(stick.style.left);
        this.originY = parseInt(stick.style.top);
        var result = {
            stickLeft: undefined,
            stickTop: undefined,
            stickOffsetLeft: 0,
    ...
    findLockedCoord(position, distance, radius) {
        var b = [];
    ...
    mouseMoveHandler(e, scope) {
        ...
        if (result.distance > lockedDistanceOffset) {
            ...
            result.lockedPos = scope.findLockedCoord({
                ...
                */
                ...
                switch (conf.type) {
                    ...
                    case 'rotateY':
                        ...
                        break;
                    case 'rotateZ':
                        rotateMatrix4 = rotateMatrix4z;
                        break;
                    case 'rotateXY':
                        rotateMatrix4 = mmp(rotateMatrix4x, rotateMatrix4y);
                        break;
                    case 'rotateXZ':
                        rotateMatrix4 = mmp(rotateMatrix4x, rotateMatrix4z);
                        break;
                    case 'rotateYX':
                        rotateMatrix4 = mmp(rotateMatrix4y, rotateMatrix4x);
                        break;
                    case 'rotateYZ':
                        rotateMatrix4 = mmp(rotateMatrix4y, rotateMatrix4z);
                        break;
                    case 'rotateZX':
                        rotateMatrix4 = mmp(rotateMatrix4z, rotateMatrix4x);
                        break;
                    case 'rotateZY':
                        rotateMatrix4 = mmp(rotateMatrix4z, rotateMatrix4y);
                        break;
                    case 'rotateXYZ':
                        rotateMatrix4 = mmp(mmp(rotateMatrix4x, rotateMatrix4y), rotateMatrix4z);
                        break;
                    case 'rotateXZY':
                        rotateMatrix4 = mmp(mmp(rotateMatrix4x, rotateMatrix4z), rotateMatrix4y);
                        break;
                    case 'rotateYXZ':
                        rotateMatrix4 = mmp(mmp(rotateMatrix4y, rotateMatrix4x), rotateMatrix4z);
                        break;
                    case 'rotateYZX':
                        rotateMatrix4 = mmp(mmp(rotateMatrix4y, rotateMatrix4z), rotateMatrix4x);
                        break;
                    case 'rotateZXY':
                        rotateMatrix4 = mmp(mmp(rotateMatrix4z, rotateMatrix4x), rotateMatrix4y);
                        break;
                    case 'rotateZYX':
