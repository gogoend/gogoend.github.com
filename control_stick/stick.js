...
var Stick = function (conf) {
    ...
    //变换目标
    if (!conf.target || !conf.target instanceof Element || !conf.target instanceof THREE.Object3D) {
    ...
    //动态算出手柄起始位置
    _this.originX = parseInt(_this.zone.style.left);
    _this.originY = parseInt(_this.zone.style.top);
...
Stick.prototype.getDirection=function(e){
    ...
    Stick.prototype.getMatrix=function(conf){
